    ...
    return (
        <div>
            <div className="flex h-screen bg-gray-200">
                <div className={`fixed z-20 inset-0 bg-black opacity-50 transition-opacity xl:hidden ${sidebarOpen ? 'block' : 'hidden'}`} onClick={() => setSidebar(false)}></div>

                <div className={`fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto xl:translate-x-0 xl:static xl:inset-0 ${sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'}`}>
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                        <div className="xl:container w-full mx-auto px-3 py-8">
